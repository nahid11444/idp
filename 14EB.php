    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-light fixed-top">
                ...
                <a class="navbar-brand">CASUALTY EVACUATION 14 EB</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                             <a class="nav-link" href="14eb_evac_req.php">Pending Evacuation</a> <!--add unit list  from database here -->
                                             <a class="nav-link" href="14eb_complete_evac.php">Evacuation Completion State</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>                           
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">WELCOME TO 14 EB PANEL</h2>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
